...
public class JwtVerificationFilter extends OncePerRequestFilter {
    ...
    private void setAuthenticationToContext(Map<String, Object> clamis) {
        String username = (String) clamis.get("username");
        List<GrantedAuthority> authorities = authorityUtils.createAuthorities((List)clamis.get("roles"));
